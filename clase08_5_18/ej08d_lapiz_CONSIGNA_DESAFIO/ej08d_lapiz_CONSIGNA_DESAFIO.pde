...
/*
  DESAFIOS PARA COMPLETAR EL PAINT
  1. hacer evento over en los botones
  2. marcar que boton está seleccionado
  3. guardar el dibujo realizado
     - saveFrame();
  4. SOL: "con mousePressed le pones que cambie a un color mas oscuro"
  5. Dibujar otro tipo de figuras:
     - una linea
     - un cuadrado
     - un circulo
     - etc (má dificil)
  6. ¿Qué más se les ocurre...?
